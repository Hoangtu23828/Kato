...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>KatoVn chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "KatoVn", HidePremium = false, IntroText = "KatoVn⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("KatoVn SCRIPT")
W:AddLabel("DiscordKatoVn")
local Section = W:AddSection({
    Name = "Status"
})
